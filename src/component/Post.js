                ...
                <div className="postBody">
                    ...
                    <div className="postContent">
                        ...
                        <div className="postDesc">
                            <span className="desc">
                                {likeStatus
                                    ? <button className='like_button' onClick={() => addLike(post.id)}>
                                        <ThumbUpIcon />
                                    </button>
                                    : <button className='like_button' onClick={() => addLike(post.id)}>
                                        <FavoriteBorderIcon />
                            ...
                            <span className="desc">
                                <button className='like_button' onClick={handleShowComments}>
    ...
    <div className="comment">
        ...
        <div className="commentBody">
            <div className="commentHeader">
                ...
                <span className="publishDate">{moment(new Date(commentInfo.commentDate)).fromNow()}</span>
            </div>
